  ...
  return (
    <section id={id} className={styles.container}>
      <div className={styles.content}>
          ...
          <p>
            I&apos;m a software developer, with a special focus on UI and building visually appealing applications that are
            intuitive for end users. My skill set is a blend of creativity and technical expertise, with an end goal of
            delivering user-centric designs and features that align with business goals.
          </p>
          <ul>
